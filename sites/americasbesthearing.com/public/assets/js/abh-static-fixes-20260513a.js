(function () {
  ...
  ready(() => {
    ...
    setupSlider(document.querySelector('.astro-element-6e2ff94'), { autoplay: false, speed: 500, arrows: true, gap: 0, paginationAllSlides: true, loopClones: 'visibleMinusOne', swiperStateClasses: true, offset: { desktop: 0, laptop: 0, tablet: 0, mobile: 0 } });
