(function () {
  ...
  function setupSlider(root, options) {
    ...
    const rebuildLoop = () => {
      ...
      cloneCount = Math.min(options.loopClones, originalSlides.length);
  ...
  ready(() => {
    ...
    setupSlider(document.querySelector('.astro-element-6e2ff94'), { autoplay: false, speed: 500, arrows: true, gap: 0, paginationAllSlides: true, offset: { desktop: 60, laptop: 60, tablet: 40, mobile: 42 } });
